...
<body>
    <h1 class="text-center bg-primary" style="color:rgb(253, 253, 253);">Pendaftaran Ekstrakurikuler SMA</h1>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $data_result->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge 
                                                        <?= $row['status_pendaftaran'] === 'diterima' ? '-succesbgs' : ($row['status_pendaftaran'] === 'ditolak' ? 'bg-danger' : 'bg-warning') ?>">
